...
export const ANALYTICS = {
  ...
  profile: {
    ...
    view: {
      name: "view",
      action: "Profile Admin Viewed",
    },
  },
  recipient: {
    category: "Recipient",
    viewUploadLogs: {
      name: "recipient-view-upload-logs",
      action: "View upload log",
    },
    sampleCsvDownload: {
      name: "recipient-sample-csv-download",
      action: "Sample CSV Downloaded",
    },
    sampleCsvUpload: {
      name: "recipient-csv-upload",
      action: "Recipient CSV Uploaded",
    },
    csvUploadFail: {
      name: "recipient-csv-upload-fail",
      action: "Upload Validation Failed",
    },
    csvUploadSuccess: {
      name: "recipient-csv-upload-success",
      action: "Upload Validation Succeeded",
    },
  },
  message: {
    category: "Message",
    ...
    stepAttachments: {
      name: "message-step-attachments",
      action: "Message attachments uploaded",
    },
    stepSchedule: {
