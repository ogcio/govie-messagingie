 ...
 * sign-out cookies. Returns undefined for hosts without a shared parent
 * (e.g. `localhost`), yielding a host-only cookie.
 */
...
export function writeLocaleCookie(locale: Locale): void {
  ...
  // biome-ignore lint/suspicious/noDocumentCookie: the suggested Cookie Store API is async and unsupported in the browsers we target
