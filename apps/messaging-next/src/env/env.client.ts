...
export const env = createEnv({
  client: {
    NEXT_PUBLIC_BASE_URL: requiredUrl.default("http://localhost:3002"),
    NEXT_PUBLIC_SAG_URL: requiredUrl,
    NEXT_PUBLIC_SAG_APP_NAME: z.string().default("messaging"),
    /** Profile service URL — used for onboarding and wrong-login-method redirects */
    NEXT_PUBLIC_PROFILE_URL: requiredUrl.default("http://localhost:3003"),
    /** Messaging admin URL — public servants are redirected here */
    NEXT_PUBLIC_MESSAGING_ADMIN_URL: requiredUrl.default(
      "http://localhost:3022",
    ),
    /** Dashboard URL — used for drawer navigation */
    NEXT_PUBLIC_DASHBOARD_URL: requiredUrl.default("http://localhost:3001"),
