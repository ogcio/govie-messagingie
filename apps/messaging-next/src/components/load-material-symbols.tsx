...
/**
 * Extends the DS Material Symbols preload with icons used in messaging-next
 * that are not yet in `@ogcio/design-system-react`'s `LoadMaterialSymbols`
 * subset (e.g. `drive_file_move` on the message detail toolbar and the
 * attachment-card file-type icons).
 */
