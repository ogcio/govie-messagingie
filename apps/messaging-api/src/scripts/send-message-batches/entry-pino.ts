...
import { createPinoLogger } from "./logging/create-pino-logger.js";
import { createNoopOperatorOutput } from "./logging/operator-output.js";
...
async function main(): Promise<void> {
  ...
  const operatorOutput = createNoopOperatorOutput();
