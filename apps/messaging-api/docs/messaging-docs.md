# OGCIO MessagingIE API Documentation

## Overview

This document describes the API for the OGCIO MessagingIE Building Block. The API version is 1.0.0.
...
```json
{
  "preferredTransports": ["email", "lifeEvent"],  // List of preferred transports to use
...
- `type` (required): Provider type. Possible values: "email"
- `offset` (optional, default: 0): Number of records to skip
- `limit` (optional, default: 20, max: 100): Maximum number of records to return
  ...
  "data": [
    {
      ...
      "organisationPreferredTransports": ["email"],  // The list of the preferred transports to use
...
```json
{
  ...
  "preferredTransports": ["email"]  // The list of the preferred transports to use
}
```
    ...
    "usersData": [
      {
        ...
        "relatedUserId": "string",  // Related user id from the MessagingIE building block, if available
  ...
  "data": [
    {
      ...
      "organisationPreferredTransports": ["email"],  // List of preferred transports to use
